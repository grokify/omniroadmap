...
func (_d *ItemAugmentDelete) Where(ps ...predicate.ItemAugment) *ItemAugmentDelete {
...
func (_d *ItemAugmentDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(itemaugment.Table, sqlgraph.NewFieldSpec(itemaugment.FieldID, field.TypeString))
...
type ItemAugmentDeleteOne struct {
	_d *ItemAugmentDelete
}

// Where appends a list predicates to the ItemAugmentDelete builder.
func (_d *ItemAugmentDeleteOne) Where(ps ...predicate.ItemAugment) *ItemAugmentDeleteOne {
...
func (_d *ItemAugmentDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{itemaugment.Label}
	default:
		return nil
	}
}
