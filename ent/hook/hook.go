...
// The CustomFieldDefFunc type is an adapter to allow the use of ordinary
// function as CustomFieldDef mutator.
type CustomFieldDefFunc func(context.Context, *ent.CustomFieldDefMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CustomFieldDefFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CustomFieldDefMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CustomFieldDefMutation", m)
}

// The DimensionOptionFunc type is an adapter to allow the use of ordinary
// function as DimensionOption mutator.
type DimensionOptionFunc func(context.Context, *ent.DimensionOptionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DimensionOptionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DimensionOptionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DimensionOptionMutation", m)
}
...
// The ItemAugmentFunc type is an adapter to allow the use of ordinary
// function as ItemAugment mutator.
...
func (f ItemAugmentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ItemAugmentMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ItemAugmentMutation", m)
}

// The OpportunityAssessmentFunc type is an adapter to allow the use of ordinary
// function as OpportunityAssessment mutator.
type OpportunityAssessmentFunc func(context.Context, *ent.OpportunityAssessmentMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OpportunityAssessmentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OpportunityAssessmentMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OpportunityAssessmentMutation", m)
}

// The OpportunitySpecFunc type is an adapter to allow the use of ordinary
// function as OpportunitySpec mutator.
type OpportunitySpecFunc func(context.Context, *ent.OpportunitySpecMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OpportunitySpecFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OpportunitySpecMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OpportunitySpecMutation", m)
}

// The PortfolioDimensionFunc type is an adapter to allow the use of ordinary
// function as PortfolioDimension mutator.
type PortfolioDimensionFunc func(context.Context, *ent.PortfolioDimensionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PortfolioDimensionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PortfolioDimensionMutation); ok {
		return f(ctx, mv)
	}
...
func (f RankOverrideFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RankOverrideMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RankOverrideMutation", m)
}
...
// The ReportDatasetFunc type is an adapter to allow the use of ordinary
// function as ReportDataset mutator.
type ReportDatasetFunc func(context.Context, *ent.ReportDatasetMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ReportDatasetFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ReportDatasetMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ReportDatasetMutation", m)
}
