...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			customfielddef.Table:        customfielddef.ValidColumn,
			dimensionoption.Table:       dimensionoption.ValidColumn,
			evidence.Table:              evidence.ValidColumn,
			item.Table:                  item.ValidColumn,
			itemaugment.Table:           itemaugment.ValidColumn,
			...
			syncmeta.Table:              syncmeta.ValidColumn,
		})
	})
