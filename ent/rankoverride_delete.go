...
func (_d *RankOverrideDelete) Where(ps ...predicate.RankOverride) *RankOverrideDelete {
...
func (_d *RankOverrideDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(rankoverride.Table, sqlgraph.NewFieldSpec(rankoverride.FieldID, field.TypeString))
...
type RankOverrideDeleteOne struct {
	_d *RankOverrideDelete
}

// Where appends a list predicates to the RankOverrideDelete builder.
func (_d *RankOverrideDeleteOne) Where(ps ...predicate.RankOverride) *RankOverrideDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *RankOverrideDeleteOne) Exec(ctx context.Context) error {
	n, err := _d._d.Exec(ctx)
	switch {
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{rankoverride.Label}
	default:
		return nil
	}
}
