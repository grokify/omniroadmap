...
func (_d *SyncMetaDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(syncmeta.Table, sqlgraph.NewFieldSpec(syncmeta.FieldID, field.TypeInt))
...
// Where appends a list predicates to the SyncMetaDelete builder.
func (_d *SyncMetaDeleteOne) Where(ps ...predicate.SyncMeta) *SyncMetaDeleteOne {
...
func (_d *SyncMetaDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{syncmeta.Label}
	default:
		return nil
	}
}
