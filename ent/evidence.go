...
func (*Evidence) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case evidence.FieldID, evidence.FieldSystem, evidence.FieldSensitivity, evidence.FieldCapturedBy, evidence.FieldSourceURI:
			values[i] = new(sql.NullString)
		case evidence.FieldCapturedAt, evidence.FieldCreatedAt, evidence.FieldUpdatedAt:
...
func (_m *Evidence) String() string {
	...
	builder.WriteString(_m.CapturedBy)
	builder.WriteString(", ")
